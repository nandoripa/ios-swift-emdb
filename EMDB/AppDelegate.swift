...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(updateFavouritesBadge), name: Notification.Name("updateFavouritesBadgeNotificaction"), object: nil)
        
        let dataProvider = LocalCoreDataService()
        dataProvider.updateFavouritesBadge()
        
        return true
    }
    
    func updateFavouritesBadge(notification: Notification) {
