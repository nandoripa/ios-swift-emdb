...
class RemoteiTunesMovieService {
    ...
    func searchMovies(byTerm: String, completionHandler: @escaping ([[String:String]]?) -> Void){
        ...
        Alamofire.request(url, method: .get, parameters: ["media": "movie", "attribute": "movieTerm", "country": "es", "term": byTerm], encoding: URLEncoding.default, headers: nil).responseJSON() { response in
